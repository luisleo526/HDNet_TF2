...
##############################    Inference Code     ##################################
pre_ck_pnts_dir_DR =  "../training_progress/model/HDNet"
model_num_DR = '500'
pre_ck_pnts_dir_NP =  "../training_progress/model/NormalEstimator"
model_num_NP = '500'
IMAGE_HEIGHT = 256
IMAGE_WIDTH = 256
...
with sess2.as_default():
    with NormNet_graph.as_default():
        ...
        saver2 = tf.compat.v1.train.import_meta_graph(pre_ck_pnts_dir_NP+'/model_'+model_num_NP+'/model_'+model_num_NP+'.ckpt.meta')
