...
def conv_layer(input_tensor,name,kernel_size,output_channels,initializer=tf.compat.v1.keras.initializers.VarianceScaling(),stride=1,bn=False,training=False,relu=True):
	...
	with tf.compat.v1.variable_scope(name) as scope:
		...
		conv = tf.nn.conv2d(input_tensor, filters=kernel, strides=[1, stride, stride, 1], padding='SAME')
